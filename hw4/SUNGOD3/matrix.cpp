...
PYBIND11_MODULE(_matrix, m) {
    ...
    m.def("bytes", []() { return MemoryStats::current_bytes.load(); });
    m.def("allocated", []() { return MemoryStats::total_allocated.load(); });
    m.def("deallocated", []() { return MemoryStats::total_deallocated.load(); });
}