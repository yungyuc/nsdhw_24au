...
PYBIND11_MODULE(_matrix, m){
    ...
    m.def("bytes", &OurAllocator<double>::bytes, "Get Bytes");
    m.def("allocated", &OurAllocator<double>::allocated, "Get Allocated Bytes");
    m.def("deallocated", &OurAllocator<double>::deallocated, "Get Deallocated Bytes");
